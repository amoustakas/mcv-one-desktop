...
// creditsProcessor is MCV-Desktop-specific (Supabase ledger) and not shipped
// in the SDK. Consumers that want platform credits inject their own via
// PaymentRouter#register() after construction.
...
export class PaymentRouter {
  ...
  constructor() {
    ...
    // Consumers that want credits call: new PaymentRouter().register(creditsProcessor)
  }
