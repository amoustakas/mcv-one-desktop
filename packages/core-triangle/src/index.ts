// @mcv/core-triangle — unified client factory for the three MCV microservices.
//
// Usage (in any venture app):
//   import { createCoreTriangle } from '@mcv/core-triangle';
...
//   if (session.ok) { ... } else { /* graceful fallback */ }
...
export interface CoreTriangle {
  ...
  ping(): Promise<{ identity: boolean; fabric: boolean; intelligence: boolean }>;
}
...
export const MCV_CORE_TRIANGLE_SDK_VERSION = '0.1.0' as const;
