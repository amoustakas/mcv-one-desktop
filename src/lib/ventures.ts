// Types live in @mcv/ventures-sdk; this file owns the actual venture registry
// (MCV's ventures) + the 3 array-helper functions over it.
import type { Venture } from '@mcv/ventures-sdk/types';
export type {
  Venture,
  VentureSocials,
  VentureTeamMember,
