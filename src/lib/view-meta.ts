...
export const VIEW_ICONS: Record<string, LucideIcon> = {
  ...
  'ventures-index': Layers, 'venture-detail': LayoutGrid,
  'venture-wizard': Sparkles, 'department-portfolio': Shield,
...
export const VIEW_LABELS: Record<string, string> = {
  ...
  'factory-console': 'Factory Console',
  ...
  'ventures-index': 'Ventures', 'venture-detail': 'Workspace',
  'venture-wizard': 'Wizard', 'department-portfolio': 'Departments',
