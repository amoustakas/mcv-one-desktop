...
export const manifest: KitManifest = {
  id: 'microsoft-ads', name: 'Microsoft Ads', version: '1.0.0',
  description: 'Microsoft Advertising (Bing Ads) — campaigns, ad groups, keywords, budgets, and performance.',
...
export const handlers: Record<string, KitToolHandler> = { msads_campaigns: listCampaigns, msads_ad_groups: listAdGroups, msads_keywords: listKeywords, msads_overview: msAdsOverview };
