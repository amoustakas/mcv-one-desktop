...
export default function CommandPalette({ open, onClose }: CommandPaletteProps) {
  ...
  const staticItems: PaletteItem[] = [
    ...
    { id: 'v-agents', label: 'Agent Roster', sublabel: 'The Team — Atlas + 12 specialists', category: 'Views', action: () => { setView('agents'); } },
    { id: 'v-agent-chat', label: 'Agent Chat', sublabel: 'Start a conversation with any agent', category: 'Views', action: () => { setView('agent-chat'); } },
    { id: 'v-capital-foundation', label: 'Capital Foundation', sublabel: 'Treasury / distribution / royalty / compliance dashboard', category: 'Views', action: () => { setView('capital-foundation'); } },
