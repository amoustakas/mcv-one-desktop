...
import OrgChartTree from '../components/naos/OrgChartTree';
import RosterTable from '../components/naos/RosterTable';
import CulturePulse from '../components/naos/CulturePulse';
import AgentDetailPanel from '../components/naos/AgentDetailPanel';
import '../styles/naos.css';

// Placeholder components removed — now using real components from src/components/naos/
        ...
        {loading ? (
          ...
          <>
            {activeTab === 'org-chart' && (
              <div className="naos-layout">
                <div className="naos-main">
                  <OrgChartTree agents={agents} onSelect={setSelectedId} selectedId={selectedId} />
                </div>
                {selectedAgent && (
                  <AgentDetailPanel
                    agent={selectedAgent}
                    personality={selectedAgent.personality}
                    emotional={selectedAgent.emotional}
            ...
            {activeTab === 'roster' && (
              <div className="naos-layout">
                <div className="naos-main">
                  <RosterTable agents={agents} onSelect={setSelectedId} selectedId={selectedId} />
                </div>
                {selectedAgent && (
                  <AgentDetailPanel
                    agent={selectedAgent}
