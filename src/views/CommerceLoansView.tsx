          ...
          {loansLoading ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              ...
              {filtered.map((l) => {
                ...
                return (
                  <div key={String(loan.id)} style={{ display: 'grid', gridTemplateColumns: '1fr 140px 100px 100px 100px 100px 80px', padding: '10px 0', borderBottom: '1px solid var(--border)', fontSize: 13, gap: 8, alignItems: 'center' }}>
