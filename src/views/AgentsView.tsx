...
export default function AgentsView() {
  ...
  return (
    <PageShell>
      <PageHeader
        title="The Team"
        subtitle="The specialists who run the MCV ecosystem beside you. Each one is a named professional with their own persona, voice, tool belt, and scope. Mention them by handle, route chats through them, or schedule them to run on cron."
      />
