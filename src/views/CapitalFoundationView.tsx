  ...
  return (
    <PageShell>
      <PageHeader
        ...
        description="The five-tuple primitive powering every venture's monetization — live data from capital_treasury, capital_royalty_graph, capital_distribution_config, capital_compliance_rule_set, and capital_legal_entity."
      />
